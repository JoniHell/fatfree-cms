...
class Image {
	...
	**/
	function captcha($font,$size=24,$len=5,
		...
		$fw=Base::instance();
                /* had to hardcode path for windows, fucking windows TODO: change to og format */
                $path = 'D:/apps/xampp/htdocs/ui/fonts/UmbraTL-Regular.ttf';
		foreach ($fw->split($path?:$fw->UI.';./') as $dir)
			if (is_file('D:/apps/xampp/htdocs/ui/fonts/UmbraTL-Regular.ttf')) {
